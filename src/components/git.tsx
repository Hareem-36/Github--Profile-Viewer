...
export default function GitHubProfileViewer() {
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen bg-gradient-to-br from-lime-600 to-pink-50">
      <Card className="w-full max-w-3xl p-6 space-y-4 shadow-lg rounded-lg bg-white">
        <CardHeader className="text-center">
          <u><CardTitle className="text-3xl font-bold mb-2 text-blue-900">
            GitHub Profile Viewer
          </CardTitle></u>
          <b><CardDescription className="text-blue-600">
